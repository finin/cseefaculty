...
member includes
  ...
  -- program (C for CS or E for ECE)
  -- status (TT, PP, R, V, L, PD)
  -- first academic year in service 
...
We can use a simple Python program to create the spreadsheets and
charts we want.  Https://github.com/finin/cseefaculty is a public
GitHub repo with the data and code.

With reasonably complete data that includes lecturers we can easily
